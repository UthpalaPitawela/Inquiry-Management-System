                                          ...
                                          <div class="modal-dialog">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <form id="smssummaryform<?php echo $post['r_id']; ?>" class="form-horizontal" method="POST" action="<?php echo base_url();?>index.php/sms/Sendsms_summary/send">

                                                        <input type="text" name="regid" id="regid" value="<?php echo $post['r_id']; ?>" hidden="hidden" />
                                                        <input type="text" name="page" id="page" value="2" hidden="hidden" />
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <form class="form-horizontal" method="POST" action="<?php echo base_url();?>index.php/Summary_controller/updateEmailSummary">
                                                        ...
                                                        <input type="text" name="regid" id="regid" value="<?php echo $post['r_id']; ?>" hidden="hidden" />
                                                                    <div class="form-group">
                                                                        <label class="col-md-3 col-xs-12 control-label" for="email">Enter Email:</label>
                                                                        <div class="col-md-8 col-xs-12">     
                                                                            
                                                                            <input type="text" class="form-control" name="email" id="email" value="<?php echo $post['Email']; ?>" />
                                                                        </div>
                                                                    </div>
                                          ...
                                          <div class="modal-dialog">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <form id="smssummaryform2<?php echo $post['r_id']; ?>" class="form-horizontal" method="POST" action="<?php echo base_url();?>index.php/sms/Sendsms_summary/send">
                                          ...
                                          <div class="modal-dialog">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <form class="form-horizontal" id="smssummaryform3<?php echo $post['r_id']; ?>" method="POST" action="<?php echo base_url();?>index.php/sms/Sendsms_summary/send">
...
<script>           
    function check_sms(tp,r_id) {
        ...
        var message=document.getElementById('smsmessage1'+r_id).value;
   ...
   $('#searchname').click(function() {
    ...
    $("#programmeresult").html("");  
     ...
     // $("#contactnodiv").html("");
          ...
          $('#programmeresult').click(function() {
      $("#tagresultdiv").html("");
      $("#namediv").html("");
        $("#contactnodiv").html("");
//      $("#programmeresult").html("");
...
$.ajax({             
                     type:"post",
                     url : '<?php echo base_url();?>index.php/Tag_Controller/searchTagforAll/',
                     data : {skey:searchtag},
 ...
 //var searchtag = document.getElementById("searchtag").value;
   ...
   $('#programmeresult').html("<table><tr><td><li><a href='<?php echo base_url();?>index.php/ManageInquiries_controller/programmeindex/1'><span class='fa fa-users'>&nbsp</span>BSC(Hons) Computing</a></li></td></tr><tr><td><li><a href='<?php echo base_url();?>index.php/ManageInquiries_controller/programmeindex/2'><span class='fa fa-users'>&nbspBA(Hons) Business Studies</a></li></td></tr><tr><td><li><a href='<?php echo base_url();?>index.php/ManageInquiries_controller/programmeindex/3'><span class='fa fa-users'>&nbspBA(Hons) Business & Marketing</a></li></td></tr><tr><td><li><a href='<?php echo base_url();?>index.php/ManageInquiries_controller/programmeindex/4'><span class='fa fa-users'>&nbspBA(Hons) International Business</a></li></td></tr><tr><td><li><a href='<?php echo base_url();?>index.php/ManageInquiries_controller/programmeindex/5'><span class='fa fa-users'>&nbspBA(Hons) Accounting & Finance</a></li></td></tr><tr><td><li><a href='<?php echo base_url();?>index.php/ManageInquiries_controller/programmeindex/6'><span class='fa fa-users'>&nbspHigher National Diploma in Business</a></li></td></tr><tr><td><li><a href='<?php echo base_url();?>index.php/ManageInquiries_controller/programmeindex/7'><span class='fa fa-users'>&nbspHigher National Diploma in Computer Science</a></li></td></tr><tr><td><li><a href='<?php echo base_url();?>index.php/ManageInquiries_controller/programmeindex/8'><span class='fa fa-users'>&nbspFoundation</a></li></td></tr><tr><td><li><a href='<?php echo base_url();?>index.php/ManageInquiries_controller/programmeindex/9'><span class='fa fa-users'>&nbspOther</a></li></td></tr><tr><td><li><a href='<?php echo base_url();?>index.php/ManageInquiries_controller/programmeindex/10'><span class='fa fa-users'>&nbspMBA</a></li></td></tr></table");
...
<script type="text/javascript">
  ...
  $.ajax({             
                       type:"post",
                       url : '<?php echo base_url();?>index.php/ManageInquiries_controller/searchbyName/',
                       data : {skey:searchkey},
                       success: function(searchresult) {
  ...
  $.ajax({             
                       type:"post",
                       url : '<?php echo base_url();?>index.php/ManageInquiries_controller/searchbyNo/',
                       data : {skey:searchkey},
                       success: function(searchresult) {
