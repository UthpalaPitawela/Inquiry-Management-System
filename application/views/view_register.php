            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-xs-12">
                        <div class="input-group">
                            ...
                            <input type="date" name="pdate" class="form-control datepicker">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-xs-12" id="ss">
                        <button class="btn btn-primary pull-right" id="eligle">View Eligible Programmes</button>
                    </div>
                </div>
                &nbsp;
